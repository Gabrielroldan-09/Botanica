// =============================================
// BOTÁNICA HERRERA — productos.js
// Lógica del CRUD completo de productos
// =============================================
...
function renderTabla(data) {
  ...
  if (!data.length) {
    showEmptyState('productos-body', 'Sin productos', 'No hay productos registrados. ¡Agregá el primero!');
    return;
  }
...
function abrirModalNuevo() {
  ...
  document.getElementById('modal-submit-btn').textContent = 'Guardar Producto';
  abrirModal();
}
